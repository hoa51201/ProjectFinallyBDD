...
import buihanh.utils.DateUtils;
...
public class CucumberListener implements EventListener {
    ...
    private ExtentPDFReporter pdf;
    private ExtentExcelCucumberReporter excel;
    ...
    private void runStarted(TestRunStarted event) {
		...
		ExtentExcelCucumberReporter excel = new ExtentExcelCucumberReporter("reports" + File.separator + "Excel.xlsx");
		extent.attachReporter(excel);
        spark.config().setTheme(Theme.STANDARD);
        spark.config().setDocumentTitle(REPORT_TITLE);
        spark.config().setReportName(REPORT_TITLE);
        extent.setSystemInfo("Framework Name", REPORT_TITLE);
